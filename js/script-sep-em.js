        ...
        $.getJSON('https://cdn.shirai-store.net/assets/json/common/sepSizeOrderPrice_v1_1.json', function (priceArray) {
            ...
            function sep_emrack_selectWrite(priceArray) {
                ...
                if (readyMade == 0) {
                    ...
                    html = '<form action="/p/cart/add" method="post"><input type="hidden" name="products[' + orderName + '].productNo" value="' + orderName + '"><input type="hidden" name="products[' + orderName + '].productOptionsWithPrice[1].id" value="1" /><select name="products[' + orderName + '].productOptionsWithPrice[1].value"><option value="' + orderName + '"></option></select><input type="hidden" name="products[' + orderName + '].productOptionsWithPrice[2].id" value="2"><select name="products[' + orderName + '].productOptionsWithPrice[2].value"><option value="' + optionColor + '"></option></select><input type="hidden" name="products[' + orderName + '].productOptionsWithPrice[3].id" value="3"><select name="products[' + orderName + '].productOptionsWithPrice[3].value"><option value="ADIS-00"></option></select><input name="products[' + orderName + '].quantity" type="text" value="1" size="5"><button type="submit">カートに入れる</button></form>';
                } else {
        ...
        $.getJSON('https://cdn.shirai-store.net/assets/json/common/sepSizeOrderPrice_v1_1.json', function (priceArray) {
            ...
            function sep_emrack_selectWrite(priceArray) {
                ...
                if (optionWidthSize == '1200') {
                    ...
                    html = '<form action="/p/cart/add" method="post"><input type="hidden" name="products[' + productId + '].productNo" value="' + productId + '"><input type="hidden" name="products[' + productId + '].productOptionsWithPrice[1].id" value="1" /><select name="products[' + productId + '].productOptionsWithPrice[1].value"><option value="' + orderName + '"></option></select><input type="hidden" name="products[' + productId + '].productOptionsWithPrice[2].id" value="2"><select name="products[' + productId + '].productOptionsWithPrice[2].value"><option value="' + optionColor + '"></option></select><input type="hidden" name="products[' + productId + '].productOptionsWithPrice[3].id" value="3"><select name="products[' + productId + '].productOptionsWithPrice[3].value"><option value="ADIS-00"></option></select><input name="products[' + productId + '].quantity" type="text" value="1" size="5"><button type="submit">カートに入れる</button></form>';
                }
