$(function () {
    ...
    $(".selectRanking").each(function () {
        $(this)
            .find("select")
            .val(grobal_recommendRankingPathName.split("/").pop());
    });
...
function em_transfer() {
    if ($("#fs_ProductAuth").length) {
        var productPathName = location.pathname.substring(
            location.pathname.lastIndexOf("/") + 1
        );

        if (productPathName.indexOf("tnl-emts") === 0) {
            window.location.href =
                "https://shirai-store.net/f/sizeOrder/tnl-emts";
        } else if (productPathName.indexOf("tnl-emu") === 0) {
            window.location.href =
                "https://shirai-store.net/f/sizeOrder/tnl-emu";
        } else if (productPathName.indexOf("tnl-em") === 0) {
            window.location.href =
                "https://shirai-store.net/f/sizeOrder/tnl-em";
        } else if (productPathName.indexOf("sep-emdesk") === 0) {
            window.location.href =
                "https://shirai-store.net/f/sizeOrder/sep-emdesk";
        } else if (productPathName.indexOf("sep-em") === 0) {
            window.location.href =
                "https://shirai-store.net/f/sizeOrder/sep-emrack";
        }
    }
}
...
function getUrlRedirect_20220422() {
    ...
    if (
        url ==
        "https://shirai-store.net/p/search?tag=%E3%83%AD%E3%82%B0%E3%83%BC%E3%83%8E&keyword=%E5%B9%85150?utm_source=line&utm_medium=social&utm_campaign=stid-00041&utm_content=20220421"
    ) {
        window.location.href =
            "https://shirai-store.net/p/search?tag=%E3%83%AD%E3%82%B0%E3%83%BC%E3%83%8E&keyword=%E5%B9%85150&utm_source=line&utm_medium=social&utm_campaign=stid-00041&utm_content=20220421";
    } else if (
        url ==
        "https://shirai-store.net/p/search?keyword=%E3%83%88%E3%83%AB%E3%83%95%E3%83%A9%E3%83%83%E3%83%88%E3%80%80%E3%82%A2%E3%82%A4%E3%83%9C%E3%83%AA%E3%83%BC?utm_source=line&utm_medium=social&utm_campaign=stid-00041&utm_content=20220421"
    ) {
        window.location.href =
            "https://shirai-store.net/p/search?keyword=%E3%83%88%E3%83%AB%E3%83%95%E3%83%A9%E3%83%83%E3%83%88%E3%80%80%E3%82%A2%E3%82%A4%E3%83%9C%E3%83%AA%E3%83%BC&utm_source=line&utm_medium=social&utm_campaign=stid-00041&utm_content=20220421";
    }
...
function productDetailSeriesLink() {
    if ($("#fs_ProductDetails").length) {
        ...
        var categoryURL = $(
            "nav .fs-c-breadcrumb__list li:nth-last-child(2) a"
        ).attr("href");
        var categoryName = $(
            "nav .fs-c-breadcrumb__list li:nth-last-child(2) a"
        ).text();
...
function productDetail_ptsContentsBanner() {
    if ($("#fs_ProductDetails").length) {
        ...
        if (series[0] == "pts") {
            var html =
                '<ul id="contents-banner"><li><a href="/f/feature/pitashie-featureAndCombination"><img src="https://shiraistore.itembox.design/item/src/gNav-banner-pitashie-featureAndCombination.jpg"></a></li></ul>';
...
function productCategorySubCategoryMenu() {
    if (
        $("#fs_ProductCategory").length &&
        $(".fs-body-category-category").length != 1
    ) {
...
function searchWordSave(name, url) {
    ...
    if (!results[2]) return "";
    if (results != "")
        $("header .fs-p-searchForm__input").val(
...
function productSortSelect() {
    $(".fs-c-sortItems").each(function () {
        $(this)
            ...
            .after('<span class="display_selectedItem"></span>');
    ...
    if (results[2] == "sale20220804-20220818") {
        if (results != "") {
            $("#fs_ProductSearch h1").html(
                '<img src="https://shiraistore.itembox.design/item/src/salePage-banner-sale20220804-20220818_1184x240.jpg" alt="summer SALE 第2弾 対象商品"><br>summer SALE 第2弾 対象商品'
            );
            $(".fs-c-breadcrumb__listItem:last-child").text(
                "summer SALE 第2弾 対象商品"
            );
        ...
        if (results != "") {
            $("#fs_ProductSearch h1").html(
                '<img src="https://shiraistore.itembox.design/item/src/featurePage-banner-feature20220224_1184x240.jpg" alt="入園入学の準備"><br>入園入学の準備'
            );
        ...
        if (results != "") {
            $("#fs_ProductSearch h1").html(
                '<img src="https://shiraistore.itembox.design/item/src/salePage-banner-sale20220922-20221013_1184x240.jpg" alt="Autumn SALE 対象商品"><br>Autumn SALE 対象商品'
            );
            $(".fs-c-breadcrumb__listItem:last-child").text(
                "Autumn SALE 対象商品"
            );
        ...
        if (results != "") {
            $("#fs_ProductSearch h1").html(
                '<img src="https://shiraistore.itembox.design/item/src/salePage-banner-outlet_1184x240.jpg" alt="アウトレット 対象商品"><br>アウトレット 対象商品'
            );
            $(".fs-c-breadcrumb__listItem:last-child").text(
                "アウトレット 対象商品"
            );
        ...
        if (newWindowWidth > 480) {
            if (results != "")
                $("#fs_ProductSearch h1").html(
                    'トルフラット まとめ割<span class="subTitle">2点以上お買い上げで15%OFF</span>'
                );
        } else {
            if (results != "")
                $("#fs_ProductSearch h1").html(
        ...
        if ($("#product-comment_5").html() != "") {
            ...
            for (i = 0; variation_ary.length > i; i++) {
                ...
                htmlSource =
                    ...
                    url +
                    productCode +
                    '"><img src="https://shiraistore.itembox.design/item/src/product_variation/' +
                    productCode +
                    '.jpg" alt=""><span>' +
                    colorName +
                    "</span></a></li>";
            ...
            $("#product-comment_5").html(
                "<h4>カラー</h4><ul>" + htmlSource + "</ul>"
            );
        ...
        if ($("#product-comment_9").html() != "") {
            ...
            for (i = 0; variation_ary.length > i; i++) {
                ...
                htmlSource =
                    ...
                    url +
                    productCode +
                    '" class="variationItem"><span>' +
                    colorName +
                    "</span></a></li>";
            }
            $("#product-comment_9").html(
                "<h4>サイズ</h4><ul>" + htmlSource + "</ul>"
            );
            $("#product-comment_9").css("display", "block");
            var url_split = url.split("/");
...
function reviewSlideDown(id, cssHeight) {
    if ($(id).length) {
        ...
        $(".readMore").click(function () {
            //get data
            txt_height = parseInt(
                $(this).parent(".fs-c-reviewList__item").css("height"),
                10
            );
            ...
            $(this)
                .parent(".fs-c-reviewList__item")
                .animate({ height: new_txt_height }, 500);
            $(this).slideUp();
        });
    }
}
...
function instagramPostList() {
    if ($("#fs_Top, #shirai_fan").length) {
        $.getJSON(
            "https://cdn.shirai-store.net/assets/json/common/instagramDisplayPhoto_v1_0.json",
            function (instagramPostData) {
                ...
                for (var i in instagramPostData.reverse()) {
                    ...
                    listHtml =
                        '<li class="modal-open" data-target="instagramPost-modal" data-postid="' +
                        postId +
                        '"><img src="' +
                        thumbnail_url +
                        '" style="width:' +
    ...
    function modal_addContent(instagramPostData, thumbnail_url, element) {
        ...
        for (var i = 0; target.relatedProduct.length > i; i++) {
            ...
            var productId_12Len = zeroPadding(
                target.relatedProduct[i].productId,
                12
            );
            ...
            var averageRating = parseFloat(
                target.relatedProduct[i].averageRating
            );
            ...
            var thumbNumber = (
                "00" + target.relatedProduct[i].thumbNumber
            ).slice(-2);
            ...
            if (icon_ary != "") {
                for (var j = 0; icon_ary.length > j; j++) {
                    ...
                    if (icon_splitAry[0] == "mark-limitedProduct") {
                        icon_html +=
                            '<span class="mark-limitedProduct">当店限定商品</span>';
                    }
                    if (
                        icon_splitAry[0] == "mark-categoryRank" &&
                        icon_splitAry[1] <= 3
                    ) {
                        icon_html +=
                            '<span class="mark-catRank">' +
                            categoryName +
                            " " +
                            icon_splitAry[1] +
                            "位</span>";
            ...
            if (reviewCount != 0) {
                averageRating_html =
                    '<span class="fs-c-rating__stars fs-c-reviewStars" data-ratingcount="' +
                    averageRating +
                    '"><a href="https://shirai-store.net/f/reviewList?modelCode=' +
                    productUrl +
                    '" class="itemReviewCount">（' +
                    reviewCount +
                    "）</a></span>";
            }

            sellingPrice = String(sellingPrice).replace(
                /(\d)(?=(\d\d\d)+(?!\d))/g,
                "$1,"
            );
            normalPrice = String(normalPrice).replace(
                /(\d)(?=(\d\d\d)+(?!\d))/g,
                "$1,"
            );
            ...
            if (sellingPrice < normalPrice) {
                var price_html =
                    '<span class="itemNormalPrice itemPrice">¥ ' +
                    normalPrice +
                    '<span class="tax">(税込)</span></span><span class="itemSalePrice itemPrice"><span class="sale">特別価格</span> ¥ ' +
                    sellingPrice +
...
function soldout() {
    if (
        $(".fs-c-productNotice--outOfStock").length &&
        $(".mark-soldout").length
    ) {
        $(".fs-c-productNotice--outOfStock").html(
            "完売しました。<span>次回の入荷はございません。</span>"
        );
    }
}
...
function searchFilterTnl() {
    if ($("#fs_ProductSearch").length || $(".fs-body-category-tnl").length) {
        ...
        if (
            $.inArray("search-tnl", params) > 0 ||
            $(".fs-body-category-tnl").length
        ) {
            ...
            if (params.indexOf("幅31cm") > 0) {
                ...
                selectedWidth = "幅117cm";
                $("#tnl-height").html(
                    '<option value="" selected>高さ</option><option value="高さ60cm">高さ60cm</option><option value="高さ90cm">高さ90cm</option></select>'
                );
            }
            ...
            $(document).on(
                "change",
                "#productSearchBox.tnl #tnl-width",
                function () {
                    if (
                        $("#productSearchBox.tnl #tnl-width").val() == "幅117cm"
                    ) {
                        $("#tnl-height").html(
                            '<option value="">高さ</option><option value="高さ60cm">高さ60cm</option><option value="高さ90cm">高さ90cm</option></select>'
                        );
                        flag = 1;
                    } else {
                        if (flag == 1) {
            ...
            $("#productSearchBox.tnl button").on("click", function () {
                ...
                window.location.href =
                    "https://shirai-store.net/p/search?tag=search-tnl&keyword=%E3%82%BF%E3%83%8A%E3%83%AA%E3%82%AA" +
                    type +
                    "&sort=price_low";
            });
        }
...
function rewriteDOM() {
    if ($("#fs_ProductDetails").length) {
        ...
        if (!$(".fs-c-productCarouselMainImage__thumbnail__img").length) {
            $(".fs-c-productCarouselMainImage").css(
                "justify-content",
                "space-around"
            );
        }
        ...
        $("#optionWithPrice_1").change(function () {
            ...
            if (optionName != "ADIS-00") {
                ...
                $("#option_1").val("");
                $('#option_1 option[value="組立サービスのみ指定可"]').attr(
                    "disabled",
                    "disabled"
                );
                ...
                $('#option_1 option[value="組立サービスのみ指定可"]')
                    .removeAttr("disabled")
                    .prop("selected", true);
            }
        });
        ...
        ).insertAfter(".fs-c-button--addToCart--detail");
        ...
        if (seriseCode.indexOf("tnl-t") != -1) {
            $(".fs-c-productPostage").after(
                '<div class="sizeOrder_bannar"><img src="https://shiraistore.itembox.design/item/src/icon-sizeOrder.svg" width="30"><div>【サイズオーダー】ご希望のサイズでお作りします。<a href="/f/sizeOrder/tnl-emts">横幅1cm単位でご注文はこちら</a></div></div>'
            );
        } else if (
            seriseCode.indexOf("tnl-198") != -1 ||
            seriseCode.indexOf("tnl-18") != -1
        ) {
            $(".fs-c-productPostage").after(
    ...
    if ($("#fs_ShoppingCart").length) {
        $(".fs-c-cartTable a").each(function () {
            if ($(this).attr("href").indexOf("tnl-emts") >= 0) {
                ...
                $(this)
                    .parents(".fs-c-cartTable__product")
                    .addClass("sizeOrder");
        ...
        $(".sizeOrder").each(function () {
            ...
            if (href.indexOf("tnl-em") >= 0) {
                ...
                $(this)
                    ...
                    .attr(
                        "src",
                        "/assets/img/product/sizeOrder/tnl-em/thum/" + thumbnail
                    );
                ...
                var thumbnail =
                    orderWidth + orderDepth + "-" + orderColor + "_thum.jpg";
...
function timeSale() {
    ...
    if (
        $(
            ".fs-c-productListCarousel__list__item .mark-sale,.fs-c-productListCarousel__list__item .mark-outlet"
        ).length
    ) {
        $(".mark-sale, .mark-clearance, .mark-outlet").each(function () {
            $(this)
                .parents(".fs-c-productListCarousel__list__item")
                .addClass("time-sale");
        });
    }
    ...
    if ($(".mark-sale, .mark-clearance, .mark-outlet").length) {
        $(".mark-sale, .mark-clearance, .mark-outlet").each(function () {
            $(this)
                .parents(".fs-c-productList__list__item")
                .addClass("time-sale");
        });
    }
    ...
    if ($("body.fs-body-product .fs-c-productPrice__main__label").length) {
        ...
        var normalPrice = $(".fs-c-productPrice--selling .fs-c-price__value")
                .text()
                .replace(",", ""),
            salePrice = $(".fs-c-productPrice--member .fs-c-price__value")
                .text()
                .replace(",", "");
        var priceOffValue =
            Math.round((1 - salePrice / normalPrice) * 100 * 10) / 10;
        ...
        $("body.fs-body-product .fs-c-productStock").css(
            "display",
            "inline-block"
        );
    } else {
...
function rewriteDOMLoad() {
    if ($('body[class*="fs-body-category-"]').length) {
        ...
        $("#content-ranking .more-button a").attr(
            "href",
            "/f/ranking#" + categoryUrl
        );
    }
}
...
function featureMamihapiSeries_cart() {
    $(document).on("change", ".variationItemSelect select", function () {
        var nowProductcode_Upper = $(this)
            .parents(".productInformationBox")
            .find(".productNumber")
            .text();
        ...
        $(this)
            ...
            .each(function () {
                if ($(this).is(".variationItemSelect select option") == false) {
                    ...
                    $(this).html(
                        htmlSource.replace(
                            new RegExp(nowProductcode_Upper, "g"),
                            productcode_Upper
                        )
                    );
                }
        ...
        $(this)
            ...
            .each(function () {
                if ($(this).is(".variationItemSelect select option") == false) {
                    ...
                    $(this).html(
                        htmlSource.replace(
                            new RegExp(nowProductcode_Lower, "g"),
                            productcode_Lower
                        )
                    );
                }
...
function reviewAssistText() {
    $("#fs_WriteReview .fs-system-assistTarget #fs_input_reviewContents").attr(
        "placeholder",
...
function multipleReviewList() {
    ...
    if (url_ary[0] == "https://shirai-store.net/f/reviewList") {
        ...
        var rewviewListURL =
            "https://cdn.shirai-store.net/assets/json/reviewList/reviewList_" +
            modelCode +
            "_v2_0.json";
        var reviewScore_ary = [];
        ...
        $.getJSON(rewviewListURL, function (multipleReviewList) {
            for (var i in multipleReviewList) {
                ...
                var productUrl = multipleReviewList[i].productUrl,
                    ...
                    reviewScore = Number(multipleReviewList[i].rating).toFixed(
                        1
                    ),
                    datetime = multipleReviewList[i].datetime
                        .slice(0, 10)
                        .replace(/-/g, "/"),
                    ...
                    thumbnail = (
                        "00" + multipleReviewList[i].thumbNumber
                    ).slice(-2),
                ...
                if (prefecture == "" && ageGroup == "" && gender == "") {
                    ...
                    if (prefecture != "") {
                        profHTML =
                            profHTML +
                            '<span class="fs-c-reviewer__profile__prefecture">' +
                            prefecture +
                            "</span>";
                    }
                    if (ageGroup != "") {
                        profHTML =
                            profHTML +
                            '<span class="fs-c-reviewer__profile__ageGroup">' +
                            ageGroup +
                            "</span>";
                    }
                    if (gender != "") {
                        profHTML =
                            profHTML +
                            '<span class="fs-c-reviewer__profile__gender">' +
                            gender +
                            "</span>";
                    }
                }
                ...
                var dateHTML =
                    '<dl class="fs-c-reviewInfo__date"><dt>投稿日</dt><dd><time datetime="' +
                    datetime +
                    '" class="fs-c-time">' +
                    datetime +
                    '</time></dd></dl><div class="fs-c-reviewRating"><div class="fs-c-rating__stars fs-c-reviewStars" data-ratingcount="' +
                    reviewScore +
                    '"></div></div></div>';
            ...
            var averageScore =
                Math.round((totalScore / reviewScore_ary.length) * 10) / 10;
            ...
            var averageHTML =
                '<h2 id="totalScoreTitle">' +
                modelName +
                '総合評価<span class="fs-c-reviewInfo__stars fs-c-reviewStars" data-ratingcount="' +
                averageScore_star +
                '">' +
            ...
            $("#multipleReviewList").before(
                '<p class="fs-c-listControl__status">' +
                    reviewScore_ary.length +
                    "件中" +
                    reviewScore_ary.length +
                    "件表示</p>"
            );
            ...
            //レビュー絞り込みプルダウン
            var ratingSelectHTML =
                '<select id="selectScore"><option value="">レビュー絞り込み</option>';
            ...
            $("#selectScore").change(function () {
                ...
                $(".fs-c-listControl__status").html(
                    reviewScore_ary.length + "件中" + count + "件表示"
                );
...
function productListAddData() {
    if ($("#fs_ProductCategory").length || $("#fs_ProductSearch").length) {
        //$(function () {
        $.getJSON(
            "https://cdn.shirai-store.net/assets/json/common/dataForProductList_v2_0.json",
            function (data) {
                $(".fs-c-productListItem").each(function () {
                    url = $(this)
                        .find(".fs-c-productName > a")
                        .attr("href")
                        .split("/")
                        .pop();
                    ...
                    if (result_ranking != undefined) {
                        var categoryName = categoryNameShorter(
                            result_ranking.category
                        );
                        ...
                        var rankingHTML =
                            ...
                            categoryName +
                            " " +
                            result_ranking.categoryRanking +
                            "位</span>";
                    ...
                    if (result_price != undefined) {
                        $(this)
                            .find(".fs-c-productPrice--selling")
                            .addClass("salePrice");
                        ...
                        $(this)
                            .find(".fs-c-productPrice--selling")
                            .before(normalPriceHTML);
                    }

                    var result_reviewRating = data.reviewRating.find(function (
                        v
                    ) {
                        return v.productUrl == url;
                    });
                    ...
                    if (result_reviewRating != undefined) {
                        ...
                        if (reviewScore != 0) {
                            reviewHTML =
                                ...
                                reviewScore +
                                '"><a href="/f/reviewList?modelCode=' +
                                url +
                                '">（' +
                                result_reviewRating.reviewCount +
                                "）</a></div>";
                        } else {
                            reviewHTML = "";
                        }
...
function productDetailAddData() {
    if ($("#fs_ProductDetails").length) {
        ...
        $(".productDetailGradient span").click(function () {
            ...
            //autoにした場合のheightを取得
            autoHeight = $(".fs-p-productDescription--full")
                .css("height", "auto")
                .height();
        ...
        var dataForProductDetailUrl =
            "https://cdn.shirai-store.net/assets/json/productDetail/dataForProductDetail_" +
            modelCode +
            "_v2_1.json";
        ...
        $.getJSON(dataForProductDetailUrl, function (data) {
            ...
            if (data.rankingTop10 != undefined && data.rankingTop10 != "") {
                ...
                for (var i in data.rankingTop10) {
                    ...
                    for (var j = 0; j < icon_ary.length; j++) {
                        if (icon_ary[j] != "") {
                            ...
                            if (
                                icon_ary[j][0] == "mark-categoryRank" &&
                                categoryUrl != ""
                            ) {
                                //categoryName = categoryNameShorter(categoryName);
                                iconHtml +=
                                    '<span class="mark-rank">' +
                                    icon_ary[j][1] +
                                    "位</span>";
                            }
                            ...
                            if (icon_ary[j][0] == "mark-new") {
                                iconHtml +=
                                    '<span class="mark-new">新着</span>';
                            }

                            if (icon_ary[j][0] == "mark-longseller") {
                                iconHtml +=
                                    '<span class="mark-longseller">ロングセラー</span>';
                            }
                ...
                $(".productTop10Slider.ranking").after(
                    '<div class="fs-c-buttonContainer more-button"><a href="/f/ranking_' +
                        categoryUrl +
                        '" class="fs-c-button--standard">もっと見る</a></div>'
                );
            ...
            if (data.faq != undefined && data.faq != "") {
                ...
                $("#product-review").before(
                    `<div id="productDetail-faq"><h2 class="productDescriptionTitle">この商品に関するよくある質問</h2><dl>${faqHtml}</dl></div>`
                );
            }
            ...
            if (data.comparisonData != undefined && data.comparisonData != "") {
                ...
                for (var i in comparisonData) {
                    var productUrl = comparisonData[i].productUrl,
                        ...
                        size = comparisonData[i].size
                            .replace(/\s/g, "")
                            .replace(/×/g, "<br>"),
                        reviewScore = Number(
                            comparisonData[i].averageRating
                        ).toFixed(1),
                        reviewCount = Number(comparisonData[i].reviewCount),
                        thumbnail = (
                            "00" + comparisonData[i].thumbNumber
                        ).slice(-2);
                        ...
                        for (var j = 0; j < icon_ary.length; j++) {
                            ...
                            if (icon_ary[j] != "") {
                                ...
                                if (
                                    ...
                                    categoryName =
                                        categoryNameShorter(categoryName);
                                    comparisonIconHtml +=
                                        '<span class="mark-catRank">' +
                                        categoryName +
                                        " " +
            ...
            if (data.nextArrivalDate[0] != undefined) {
                const convertJST = new Date(
                    data.nextArrivalDate[0].nextArrivalDate
                );
                ...
                $(".fs-c-productNotice--outOfStock span").html(
                    '次回の入荷日は<strong class="newArrivalDate">「' +
                        nextArrivalDate +
                        "」</strong>頃の予定です。"
                );
            }
            ...
            if (data.ranking[0] != undefined) {
                ...
                if ($(".fs-c-productMarks").length) {
                    ...
                    $(".fs-c-productPrices").before(
                        '<div class="fs-c-productMarks"><ul class="fs-c-productMark">' +
                            iconHtml +
                            "</ul></div>"
                    );
                }
            ...
            if (data.price[0] != undefined) {
                ...
                if (data.price[0].normalPrice != salePrice) {
                    ...
                    //console.log(normalPrice);
                    var priceOffValue =
                        Math.round((1 - salePrice / normalPrice) * 100 * 10) /
                        10;
                    $(
                        ".fs-c-productPrice--selling.salePrice .fs-c-productPrice__addon__label"
                    ).before(
                        '<span class="priceOffValue">' +
                            priceOffValue +
                            "% OFF</span>"
                    );
                    //console.log(normalPrice);
            ...
            for (var i in data.reviewDetail) {
                ...
                var productUrl = data.reviewDetail[i].productUrl,
                    ...
                    reviewScore = Number(data.reviewDetail[i].rating).toFixed(
                        1
                    ),
                    datetime = data.reviewDetail[i].datetime
                        .slice(0, 10)
                        .replace(/-/g, "/"),
                    reviewBody = data.reviewDetail[i].reviewBody,
                    productId_12Len = zeroPadding(productId, 12),
                    product_image_group = Math.floor(productId / 100),
                    thumbnail = ("00" + data.reviewDetail[i].thumbNumber).slice(
                        -2
                    ),
            ...
            if (reviewCount > 0) {
                ...
                var averageHTML =
                    '<div id="averageScore"><span class="fs-c-reviewInfo__stars fs-c-reviewStars" data-ratingcount="' +
                    reviewScore +
                    '"></span><span>' +
                    averageRating +
                    "</span></div>";
                ...
                //価格上部にレビュースコアを表示
                $("#productPriceBox").before(
                    '<div id="product-ratingStars"><a href="#product-review"><span class="fs-c-reviewInfo__stars fs-c-reviewStars" data-ratingcount="' +
                        reviewScore +
                        '"></span><span>' +
                        averageRating +
                        "</span><span>（" +
                ...
                if (reviewCount < 4) {
                    ...
                    $("#multipleReviewList").append(
                        '<div class="fs-c-productReview__allReviews fs-c-buttonContainer fs-c-buttonContainer--viewAllReviews"><a href="' +
                            reviewListURL +
                            '" class="othersReview fs-c-button--viewAllReviews fs-c-button--plain"><span class="fs-c-button__label">その他のレビューを見る</span></a></div>'
                    );
                }
            } else {
                $("#product-reviewTitle").after(
                    '<p class="text-center">この商品のレビューはありません。</p>'
                );
            }
            ...
            if (data.seriesItems.length >= 1) {
                for (var i in data.seriesItems) {
                    var productUrl = data.seriesItems[i].productUrl,
                        ...
                        reviewScore = Number(
                            data.seriesItems[i].averageRating
                        ).toFixed(1),
                    ...
                    if (i == 14) {
                        if (data.seriesItems.length > 15) {
                            $(".productTop10Slider.series ul").after(
                                '<div class="fs-c-buttonContainer more-button"><a href="/c/series/' +
                                    seriesCode +
                                    '" class="fs-c-button--standard">もっと見る</a></div>'
                            );
                        }
...
if (recommend_top10Slider == null) {
    recommend_top10Slider = $(
        ".productTop10Slider.recommend .bxslider"
    ).bxSlider(top10Slider_option1);
}
if (ranking_top10Slider == null) {
    ranking_top10Slider = $(".productTop10Slider.ranking .bxslider").bxSlider(
        top10Slider_option1
    );
}
if (productDetail_top10Slider == null) {
    productDetail_top10Slider = $(
        ".productTop10Slider.series .bxslider"
    ).bxSlider(top10Slider_option1);
}
if (newLife_top10Slider1 == null) {
    newLife_top10Slider1 = $("#newLife2022 .bxslider1").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider2 == null) {
    newLife_top10Slider2 = $("#newLife2022 .bxslider2").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider3 == null) {
    newLife_top10Slider3 = $("#newLife2022 .bxslider3").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider4 == null) {
    newLife_top10Slider4 = $("#newLife2022 .bxslider4").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider5 == null) {
    newLife_top10Slider5 = $("#newLife2022 .bxslider5").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider6 == null) {
    newLife_top10Slider6 = $("#newLife2022 .bxslider6").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider7 == null) {
    newLife_top10Slider7 = $("#newLife2022 .bxslider7").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider8 == null) {
    newLife_top10Slider8 = $("#newLife2022 .bxslider8").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider9 == null) {
    newLife_top10Slider9 = $("#newLife2022 .bxslider9").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider10 == null) {
    newLife_top10Slider10 = $("#newLife2022 .bxslider10").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider11 == null) {
    newLife_top10Slider11 = $("#newLife2022 .bxslider11").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider12 == null) {
    newLife_top10Slider12 = $("#newLife2022 .bxslider12").bxSlider(
        top10Slider_option1
    );
}
if (newLife_top10Slider13 == null) {
    newLife_top10Slider13 = $("#newLife2022 .bxslider13").bxSlider(
        top10Slider_option1
    );
}
...
function recommendTop10() {
    $.getJSON(
        "https://cdn.shirai-store.net/assets/json/recommend/recommend_v2_0.json",
...
function rankingTop10(rakingTop10Type) {
    ...
    var jsonurl =
        "https://cdn.shirai-store.net/assets/json/ranking/" +
        rakingTop10Type +
        catURL +
        "_v2_0.json";
    //console.log(jsonurl);
    ...
    $(".productTop10Slider.ranking ul").after(
        '<div class="fs-c-buttonContainer more-button"><a href="/f/' +
            rakingTop10Type +
            catURL +
            '" class="fs-c-button--standard">もっと見る</a></div>'
    );
...
function calendar() {
    ...
    function cal_init() {
        ...
        for (var i = 0; i < tagObj.length; i++) {
            if (tagObj[i].className == "cal_wrapper") {
                var calId = Number(
                    tagObj[i].id.substring(3, tagObj[i].id.length)
                );
    ...
    function cal_create(calId) {
        ...
        if (d.getElementById("schedule" + calId)) {
            ...
            if (
                tdTextListArr.length > 0 &&
                d.getElementById("schedule" + calId)
            ) {
                d.getElementById("schedule" + calId).innerHTML =
                    tdTextListArr.join("");
            }
...
function slideNaviResizeHeight() {
    ...
    $("#header-keywordSearch .slideNavi-list-category-item").css(
        "height",
        slideNaviHeight - 160
    );
}
...
function windowWidthDOMChange() {
    ...
    if ($("#magazine-type1").length) {
        $(".magazine-product-block .thumImageBox").height(
            $("#magazine-type1 .mainImageBox").width()
        );
    }
    ...
    if (windowWidth > 1024) {
        ...
        if ($("#fs_ProductDetails").length) {
            $(".fs-l-productLayout__item--1 #_rcmdjp_display_1").prependTo(
                ".fs-l-productLayout__item--2"
            );
            $(".fs-l-productLayout__item--1 #product-banner").prependTo(
                ".fs-l-productLayout__item--2"
            );
            $(".fs-l-productLayout__item--1 #productInformationBox").prependTo(
                ".fs-l-productLayout__item--2"
            );
        }
        /* slideNavi featureBox change */
        $("#slideNavi #header-globalNavi-bannerArea").insertAfter(
            "#productNavi .globalNavi-productList-bottom"
        );
        ...
        if ($("#fs_ProductDetails").length) {
            if ($("#productImageBoxBottomBanner").length) {
                $(
                    ".fs-l-productLayout__item--2 #productInformationBox"
                ).insertAfter("#productImageBoxBottomBanner");
            } else {
                $(
                    ".fs-l-productLayout__item--2 #productInformationBox"
                ).insertAfter("#productImageBox");
            }
            $(".fs-l-productLayout__item--2 #_rcmdjp_display_1").insertAfter(
                "#product-review"
            );
            $(".fs-l-productLayout__item--2 #product-banner").insertAfter(
                "#product-review"
            );

            $("#productDetail-rankingTop10").insertAfter(
                "#productDetail-comparison"
            );
            //console.log('AA');
        }
        /* slideNavi featureBox change */
        $("#productNavi #header-globalNavi-bannerArea").insertBefore(
            "#slideNavi-utility"
        );
...
function windowWidthprocessingChange() {
    ...
    $(document).on(
        "click",
        ".slideNavi-list-category, .slideNavi-list-series",
        function () {
            $(this).next("ul").slideToggle();
    ...
    $(document).on(
        "click",
        ".slideNavi-list-category-item > li > span",
        function () {
    ...
    if ($("#fs_ShoppingCart").length) {
        $(".fs-c-listedOptionPrice__option__value").each(function () {
            ...
            if (value == "組立宅配" || value == "組立設置") {
                $(this).after(
                    '<span class="cartADISCauton">搬入路に十分な広さがあることをご確認ください</span>'
                );
            }
        });
    }
...
function cartRegistBranch() {
    if ($("#fs_ShoppingCart").length) {
        $(".fs-c-buttonContainer--unregisteredUserPurchase span").html(
            '<span class="textDecoration">会員登録せずにお買い物する</span>'
        );
        $(".fs-c-buttonContainer--unregisteredUserPurchase a").after(
            "<span>【ご注意】送料無料&各種割引クーポンをご利用いただくには会員登録が必要です。</span>"
        );
    ...
    if ($("#fs_RegisterSuccess").length) {
        if ($.cookie("cartRegistFlag") == 1) {
            ...
            $(".fs-c-buttonContainer--myPageTop a").attr(
                "href",
