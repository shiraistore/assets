...
function optionJudgment() {
    if ($('#fs_Checkout,#fs_CheckoutWithAmazon').length) {
        ...
        var orderDisabled = function () {
            ...
            $('#fs_button_placeOrder button').css({ background: '#ccc', cursor: 'default', border: '1px solid #ccc' });
        }

        var orderEnabled = function () {
            //console.log('orderEnabled');
            $('#fs_button_placeOrder button').prop('disabled', false);
            $('#fs_button_placeOrder button').css({ background: '#e87909', cursor: 'pointer', border: '1px solid #e87909' });
        }
            ...
            if (zipCode != undefined) {
                ...
                if (checkFlag == 1) {
                    ...
                    if (deliveryDate == '指定なし' || deliveryTime == '指定なし') {
                        ...
                        if (optionResult2 >= 0) {
                            ...
                            if (!$('.deliveryMethodAlert').length) {
                                $('#fs_button_placeOrder').after('<p class="deliveryMethodAlert red text-center mt-16">お届け希望日と時間帯をご指定ください。</p>');
                            }
                        } else {
                            orderEnabled();
                            if ($('.deliveryMethodAlert').length) {
                    ...
                    if (!$('.deliveryMethodAlert2').length) {
                        ...
                        if (sizeOrderArray.find(value => value.match(/サイズオーダー/g)) != undefined || optionResult1 >= 0 || optionResult2 >= 0) {
                    ...
                    if (result >= 0) {
                        ...
                        if (optionResult1 >= 0 || optionResult2 >= 0) {
                            ...
                            if (!$('.deliveryAlert').length) {
                                $('.fs-c-checkout-destination__title').after('<div class="deliveryAlert"><p class="mb-0">お届け先が沖縄・離島の場合は「組立サービス」をご利用いただけません。<br>お届け先をご変更いただくか、該当する商品をカートから削除し、組立サービスを選択せずに再度カートに入れてからご注文ください。</p></div>');
                            }
                        } else {
                            orderEnabled();
                            if ($('.deliveryAlert').length) {
                    ...
                    if (optionResult1 >= 0 || optionResult2 >= 0) {
                        ...
                        if ($('#fs_input_payment_cashOnDelivery').prop('checked')) {
                            $('.fs-l-page').before('<div id="confirmOrderAlert"><div id="confirmOrderAlert-inner"><h4>【お知らせ】</h4><p>申し訳ございませんが、組立サービスをお申し込みの場合は代金引換をご利用いただけません</p><p>該当する商品をカートから削除し、組立サービスを選択せずに再度カートに入れてからご注文ください。</p><div class="confirmOrderAlert-button"><span>OK</span></div></div></div>');
                    ...
                    if (sizeOrderArray.find(value => value.match(/サイズオーダー/g)) != undefined) {
                        ...
                        if ($('#fs_input_payment_cashOnDelivery').prop('checked')) {
                            $('.fs-l-page').before('<div id="confirmOrderAlert"><div id="confirmOrderAlert-inner"><h4>【お知らせ】</h4><p>申し訳ございませんが、サイズオーダーをお申し込みの場合は代金引換をご利用いただけません</p><div class="confirmOrderAlert-button"><span>OK</span></div></div></div>');
                            $('.fs-c-checkout-paymentMethodList li:nth-child(2) label').trigger('click');
                            $('.confirmOrderAlert-button').on('click', function () {
                                $('#confirmOrderAlert').remove();
                            });
                    ...
                    if (result >= 0) {
                        ...
                        $('#fs_input_payment_cashOnDelivery').prop('disabled', true);
                        $('.fs-c-checkout-paymentMethod--cashOnDelivery').css('opacity', '0.5');
                        $('.fs-c-checkout-paymentMethod--cashOnDelivery .fs-c-radio__radioLabelText').html('代金引換<span class="red paymentCaution">（沖縄・離島の場合はご利用いただけません。）</span>');
                        if ($('#fs_input_payment_cashOnDelivery').prop('checked')) {
                            $('.fs-l-page').before('<div id="confirmOrderAlert"><div id="confirmOrderAlert-inner"><h4>【お知らせ】</h4><p>申し訳ございませんが、お届け先が沖縄・離島の場合は代金引換をご利用いただけません</p><div class="confirmOrderAlert-button"><span>OK</span></div></div></div>');
        ...
        setInterval(function () {
            ...
            if ($('.fs-c-checkout-delivery__method__deliveryDate').next('dd').text() != "") {
                if (($('.fs-c-checkout-delivery__method__deliveryTime').next('dd').text() != "指定なし" || $('.fs-c-checkout-delivery__method__deliveryDate').next('dd').text() != "指定なし") && stopFlag_load == 0) {
                    ...
                    $('.fs-l-page').before('<div id="confirmOrderAlert"><div id="confirmOrderAlert-inner"><h4>【お知らせ】</h4><p>お届け指定日時が「指定なし」に変更されました。お届け指定日時を再設定してください。</p><div class="confirmOrderAlert-button"><span>OK</span></div></div></div>');
                    $('.confirmOrderAlert-button').on('click', function () {
                        $('#confirmOrderAlert').remove();
                    });
                }
                ...
                if ($('.fs-c-modal--checkout-deliveryMethod').length) {
                    ...
                    if (stopFlag == 0) {
                        ...
                        var operation_holyDay = ['2021-12-04', '2021-12-05', '2021-12-11', '2021-12-12', '2021-12-18', '2021-12-19', '2021-12-25', '2021-12-26', '2021-12-28', '2021-12-29', '2021-12-30', '2021-12-31', '2022-01-01', '2022-01-02', '2022-01-03', '2022-01-08', '2022-01-09', '2022-01-15', '2022-01-16', '2022-01-22', '2022-01-23', '2022-01-29', '2022-01-30', '2022-02-05', '2022-02-06', '2022-02-12', '2022-02-13', '2022-02-19', '2022-02-20', '2022-02-23', '2022-02-26', '2022-02-27', '2022-03-05', '2022-03-06', '2022-03-12', '2022-03-13', '2022-03-19', '2022-03-20', '2022-03-26', '2022-03-27', '2022-04-02', '2022-04-03', '2022-04-09', '2022-04-10', '2022-04-16', '2022-04-17', '2022-04-23', '2022-04-24', '2022-04-29', '2022-04-30', '2022-05-01', '2022-05-02', '2022-05-03', '2022-05-04', '2022-05-07', '2022-05-08', '2022-05-14', '2022-05-15', '2022-05-21', '2022-05-22', '2022-05-28', '2022-05-29', '2022-06-04', '2022-06-05', '2022-06-11', '2022-06-12', '2022-06-18', '2022-06-19', '2022-06-25', '2022-06-26', '2022-07-02', '2022-07-03', '2022-07-09', '2022-07-10', '2022-07-16', '2022-07-17', '2022-07-23', '2022-07-24', '2022-07-30', '2022-07-31', '2022-08-06', '2022-08-07', '2022-08-11', '2022-08-12', '2022-08-13', '2022-08-14', '2022-08-15', '2022-08-20', '2022-08-21', '2022-08-27', '2022-08-28', '2022-09-03', '2022-09-04', '2022-09-10', '2022-09-11', '2022-09-17', '2022-09-18', '2022-09-19', '2022-09-24', '2022-09-25', '2022-10-01', '2022-10-02', '2022-10-08', '2022-10-09', '2022-10-10', '2022-10-15', '2022-10-16', '2022-10-22', '2022-10-23', '2022-10-29', '2022-10-30', '2022-11-05', '2022-11-06', '2022-11-12', '2022-11-13', '2022-11-19', '2022-11-20', '2022-11-26', '2022-11-27', '2022-12-03', '2022-12-04', '2022-12-10', '2022-12-11', '2022-12-17', '2022-12-18', '2022-12-24', '2022-12-25', '2022-12-29', '2022-12-30', '2022-12-31'];

                        var factory_holyDay = ['2021-12-04', '2021-12-05', '2021-12-11', '2021-12-12', '2021-12-18', '2021-12-19', '2021-12-25', '2021-12-26', '2021-12-28', '2021-12-29', '2021-12-30', '2021-12-31', '2022-01-01', '2022-01-02', '2022-01-03', '2022-01-04', '2022-01-08', '2022-01-09', '2022-01-15', '2022-01-16', '2022-01-22', '2022-01-23', '2022-01-29', '2022-01-30', '2022-02-05', '2022-02-06', '2022-02-12', '2022-02-13', '2022-02-19', '2022-02-20', '2022-02-23', '2022-02-26', '2022-02-27', '2022-03-05', '2022-03-06', '2022-03-12', '2022-03-13', '2022-03-19', '2022-03-20', '2022-03-26', '2022-03-27', '2022-04-02', '2022-04-03', '2022-04-09', '2022-04-10', '2022-04-16', '2022-04-17', '2022-04-23', '2022-04-24', '2022-04-29', '2022-04-30', '2022-05-01', '2022-05-02', '2022-05-03', '2022-05-04', '2022-05-05', '2022-05-07', '2022-05-08', '2022-05-14', '2022-05-15', '2022-05-21', '2022-05-22', '2022-05-28', '2022-05-29', '2022-06-04', '2022-06-05', '2022-06-11', '2022-06-12', '2022-06-18', '2022-06-19', '2022-06-25', '2022-06-26', '2022-07-02', '2022-07-03', '2022-07-09', '2022-07-10', '2022-07-16', '2022-07-17', '2022-07-23', '2022-07-24', '2022-07-30', '2022-07-31', '2022-08-06', '2022-08-07', '2022-08-11', '2022-08-12', '2022-08-13', '2022-08-14', '2022-08-15', '2022-08-16', '2022-08-20', '2022-08-21', '2022-08-27', '2022-08-28', '2022-09-03', '2022-09-04', '2022-09-10', '2022-09-11', '2022-09-17', '2022-09-18', '2022-09-19', '2022-09-20', '2022-09-21', '2022-09-22', '2022-09-23', '2022-09-24', '2022-09-25', '2022-10-01', '2022-10-02', '2022-10-08', '2022-10-09', '2022-10-15', '2022-10-16', '2022-10-22', '2022-10-23', '2022-10-29', '2022-10-30', '2022-11-05', '2022-11-06', '2022-11-12', '2022-11-13', '2022-11-19', '2022-11-20', '2022-11-26', '2022-11-27', '2022-12-03', '2022-12-04', '2022-12-10', '2022-12-11', '2022-12-17', '2022-12-18', '2022-12-24', '2022-12-25', '2022-12-28', '2022-12-29', '2022-12-30', '2022-12-31'];
                    ...
                    if (checkAddressRetention == '') {
                        ...
                        if ($('.fs-c-checkout-delivery__method__deliveryTime').next('dd').text() != "指定なし" || $('.fs-c-checkout-delivery__method__deliveryDate').next('dd').text() != "指定なし") {
                            ...
                            $('.fs-l-page').before('<div id="confirmOrderAlert"><div id="confirmOrderAlert-inner"><h4>【お知らせ】</h4><p>お支払い方法が銀行振込に変更されたため、<span class="red">お届け希望日時を再度指定</span>してください。</p><div class="confirmOrderAlert-button"><span>OK</span></div></div></div>');
                            $('.confirmOrderAlert-button').on('click', function () {
                                $('#confirmOrderAlert').remove();
                            });
                        }
...
function expectedArrivalTime_YHC(selected) {
    var expectedArrival_time_html;
    //YHC
    expectedArrival_time_html = '<option value="6">12:00〜15:00</option><option value="7">15:00〜18:00</option><option value="8">18:00〜21:00</option>';
    $('#fs_input_expectedArrival_time').replaceWith('<select name="time" id="fs_input_expectedArrival_time" class="fs-c-dropdown__menu"><option value="none" selected="selected">指定なし</option><option value="1">午前中</option>' + expectedArrival_time_html + '</select>');
    $('#fs_input_expectedArrival_time option[value="' + selected + '"]').prop('selected', true);
};