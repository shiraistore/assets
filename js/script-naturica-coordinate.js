$(function () {
	addCart();
	featureNaturicaCoordinate_slider();
	featureNaturicaCoordinate_cart();
});

/* addCart
========================================================================== */
function addCart() {
	$.getJSON('https://cdn.shirai-store.net/assets/json/feature/naturica-coordinate_v1_0.json', function (data) {
		//console.log(data);
...
========================================================================== */
function featureNaturicaCoordinate_slider() {
	if ($('#naturica-coordinate').length) {
...
function featureNaturicaCoordinate_cart() {
	if ($('#naturica-coordinate').length) {
